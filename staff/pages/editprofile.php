<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if(isset($_FILES['image'])){
      ...
      $sql = "UPDATE staff SET image = '".$image."' WHERE staffid = '".$_SESSION['staff_id']."'";
        $conn->query($sql);
    ...
    <!-- Main content -->
       ...
       <div class="col-lg-6 col-lg-offset-3">
              ...
              <table class="table table-striped">
                <tr>
                  <td>
                    <img height = '200' width = '200' class="img-circle elevation-2" alt="User Image" <?php
               echo "src='//localhost/SIMS/assets/images/".$_SESSION['staff_image']."'";
                ...
                <tr>
                  <td>Full Name: </td><td><?php echo $_SESSION['staff_name'] ?></td>
                </tr>
                 <tr>
                  <td>Department: </td><td><?php echo $_SESSION['staff_department'] ?></td>
                </tr>
                <tr>
                  <td>State: </td><td><?php echo $_SESSION['staff_state'] ?></td>
                </tr>
                <tr>
                  <td>Gender: </td><td><?php echo $_SESSION['staff_gender'] ?></td>
                </tr>
                <tr>
                  <td>Age: </td><td><?php echo $_SESSION['staff_age'] ?></td>
                </tr>
