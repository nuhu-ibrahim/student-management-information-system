<?php
  ...
  require_once '../../connection.php';
   ...
   if($status == 0){
    $_SESSION['error'] = "Course Registration Closed";
    header($location);
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h2 class="m-0 text-dark text-center">DROP COURSES</h2>
            ...
            <?php
              ...
              if(!empty($_SESSION['errors'])){
                   $errors = $_SESSION['errors'];
                    echo '<h4 class="alert alert-success text-center">'.$errors.'</h4>';
      ...
      <div class="col-lg-12">
        ...
        <div class="row">
          <div class="col-lg-12 col-lg-offset-1" >
            <form action="//localhost/SIMS/student/handlers/dropCourseHandler.php" method="POST">
            <table width="900px" class="table table-striped table-bordered table-hover" id="dataTables-example">
               ...
               <tbody>
                 ...
                 <?php
                  require_once '../../connection.php';
                  $sql = "SELECT * FROM courses WHERE id IN (SELECT course_id FROM student_course WHERE student_id = '".$_SESSION['student_id']."' )";
                  $result = $conn->query($sql);
                  while ($row = $result->fetch()) {
                 echo "<tr>
               ...
               <div class="row">
                   <input type="submit" class="btn btn-success" value = "drop courses"/>
               </div>
