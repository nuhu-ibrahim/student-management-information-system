  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h2 class="m-0 text-dark text-center">Add Faculty</h2>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                 <form class="form-horizontal" role="form" action = "//localhost/SIMS/admin/handlers/addFacultyHandler.php" method = "POST" enctype = "multipart/form-data">

                <div class="form-group">
                    <label for="password" class="control-label">Faculty Name</label>
                    <div class="">
                        <input type="text" name="faculty_name" placeholder="Faculty Title" class="form-control">
                    </div>
                </div>
