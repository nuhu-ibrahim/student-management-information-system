  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h2 class="m-0 text-dark text-center">Registered Students</h2>
            ...
            <table width="900px" class="table table-striped table-bordered table-hover" id="dataTables-example">
               ...
               <tbody>
                 ...
                 echo "<tr>
                    ...
                    <td>".$row['state']."</td>
                    <td> 
       <a class = 'btn btn-warning' href = '//localhost/SIMS/admin/handlers/deleteStudent.php?id=".$row['id']."'>delete</a>
                    </td>
                 </tr>";
                 }
                 ?>
