  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h2 class="m-0 text-dark text-center">Register Staff</h2>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                 <form class="form-horizontal" role="form" action = "//localhost/SIMS/admin/handlers/addstaff.php" method = "POST" enctype = "multipart/form-data">
               
                <div class="form-group">
                    <label for="firstName" class="control-label">Stsff's Name</label>
                    <div class="col-sm-">
                ...
                ?>
                 ...
                 <div class="form-group">
                    <label for="password" class="control-label">Assign Staff</label>
                    <div class="">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label for="birthDate" class="control-label">Picture</label> <br>
                    <div class="col-sm-9">
